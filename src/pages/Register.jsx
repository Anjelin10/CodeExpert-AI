...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://codeexpert-ai.onrender.com/api/auth/register', {
        method: 'POST',
  ...
  return (
    <div className="min-h-screen bg-[#09090B] rounded-lg text-[#F4F4F5] flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="relative z-10 sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="text-center text-2xl font-bold tracking-tight text-[#F4F4F5]">
          Create a new account
        </h2>
        <p className="mt-2 mb-2 text-center text-sm text-[#A1A1AA]">
      ...
      <div className="relative z-10 mt-2 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-[#18181B]/80 backdrop-blur-xl rounded-lg border border-[#27272A] py-8 px-4 shadow-2xl sm:rounded-xl sm:px-10">
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-[#D4D4D8]">
                Email address
              </label>
              <div className="mt-1.5">
                <input
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-[#D4D4D8]">
                Retype Password
              </label>
              <div className="mt-1.5">
                <input
              ...
              <p className="mt-2 text-xs text-[#71717A]">Must be at least 8 characters long.</p>
            </div>
